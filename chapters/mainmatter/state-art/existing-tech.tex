...
\acrshort{os}-level virtualization is a technology that partitions the operating system to create multiple isolated \acrfull{vm} \parencite{10.5555/1571423}. \todo{refer advantages of os-level virtualization?}
...
\paragraph{Kubernetes} This tool, also known as K8s, is an open source system for managing containerized applications across multiple hosts. It provides basic mechanisms for deployment, maintenance, and scaling of applications \parencite{kubernetes}.

\paragraph{Vagrant}

\paragraph{VMware}

\todo{mention APIs, Python modules}