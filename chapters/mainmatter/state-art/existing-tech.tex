...
\centering
\begin{tabular}{cccc}
\subfloat[Determined AI]{\includegraphics[width = 1.3in]{images/determined.png}} &
\subfloat[AutoML]{\includegraphics[width = 1.3in]{images/automl.png}} &
\subfloat[HyperOpt]{\includegraphics[width = 1.3in]{images/hyperopt.png}} &
\subfloat[Scikit Learn]{\includegraphics[width = 1.3in]{images/scikit.png}} \\
\subfloat[Ray Tune]{\includegraphics[width = 1.3in]{images/ray_tune.png}} &
\subfloat[Amazon Sagemaker]{\includegraphics[width = 1.3in]{images/sagemaker.png}} &
\subfloat[Google HyperTune]{\includegraphics[width = 1.3in]{images/google_ai.png}}
\end{tabular}
...
\todo[color=green]{Professor:\\Should I keep this? Initially used Docker, moved to Anaconda on Windows later}
...
\todo[color=green]{Professor:\\Should I mention web APIs (used them to connect to CAM2 software), Python modules (the way I use Ray Tune), FURPS model or anything else?}
...
\centering
\begin{tabular}{ccc}
\subfloat[Weights and Biases]{\includegraphics[width = 1.3in]{images/wandb.png}} &
\subfloat[TensorBoard]{\includegraphics[width = 1.3in]{images/tensorboard.png}} &
\subfloat[Neptune]{\includegraphics[width = 1.3in]{images/neptune.png}} \\
\subfloat[Guild AI]{\includegraphics[width = 1.3in]{images/guildai.jpg}} &
\subfloat[Comet]{\includegraphics[width = 1.3in]{images/coemt.png}}
\end{tabular}
