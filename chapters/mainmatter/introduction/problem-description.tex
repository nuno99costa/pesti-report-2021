...
Due to the time limitations imposed by the internship, goals were set at the beginning of the internship as part of a 1/15/45/90/120 internship overview plan \todo[color=green]{Professor:\\Should I include the overview plan (in it's full form, maybe as an annex)?}. These goals were used to guide the work and evaluate progress throughout the internship.
